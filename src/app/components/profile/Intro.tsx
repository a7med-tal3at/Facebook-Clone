...
const Intro: React.FC<IntroProps> = ({ profile }) => {
  return (
    <div
    ...
    >
      ...
      <UserInfo label="Lives in" value={profile.location}>
        <MdHome size={20} />
      </UserInfo>
      <UserInfo label="Works as" value={profile.job}>
        <MdOutlineWork size={20} />
      </UserInfo>
      <UserInfo label="Studied at" value={profile.education}>
        <IoSchool size={20} />
      </UserInfo>
      <UserInfo value={profile.bio} bio>
