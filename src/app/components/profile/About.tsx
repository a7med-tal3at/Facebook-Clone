      ...
      <div className="flex flex-col md:flex-row">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <AboutTab name="Overview" selected={selected} setSelected={setSelected} />
            <AboutTab name="Work and education" selected={selected} setSelected={setSelected} />
            <AboutTab name="Places lived" selected={selected} setSelected={setSelected} />
            <AboutTab name="Details about you" selected={selected} setSelected={setSelected} />
          </div>
        </div>
        ...
        <div className="flex flex-row flex-1">
          <div className="flex flex-col flex-1 gap-4 p-4 md:mt-12">
            {(selected === 'Overview' || selected === 'Places lived') && (
              <UserInfo label="Lives in" value={location}>
                <MdHome size={20} />
              </UserInfo>
            )}

            {(selected === 'Overview' || selected === 'Work and education') && (
              <UserInfo label="Works as" value={job}>
                <MdOutlineWork size={20} />
              </UserInfo>
            )}

            {(selected === 'Overview' || selected === 'Work and education') && (
              <UserInfo label="Studied at" value={education}>
                <IoSchool size={20} />
              </UserInfo>
            )}
